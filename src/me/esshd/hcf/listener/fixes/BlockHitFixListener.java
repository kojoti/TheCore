...
/**
 * Prevents players from breaking a break and quickly attacking a player through the block before it regenerates.
 */
public class BlockHitFixListener implements Listener {
    ...
    private static final ImmutableSet<Material> NON_TRANSPARENT_ATTACK_INTERACT_TYPES = Sets.immutableEnumSet(Material.IRON_DOOR_BLOCK, Material.IRON_DOOR, Material.WOODEN_DOOR, Material.WOOD_DOOR,
            Material.TRAP_DOOR, Material.FENCE_GATE);
    ...
    /**
     * Cancels a {@link Player} from attacking for a certain amount of milliseconds.
     *
