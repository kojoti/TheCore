...
public class Crowbar {
    ...
    public Optional<ItemStack> toItemStack() {
        if (needsMetaUpdate) {
            ...
            meta.setLore(Arrays.asList(String.format(LORE_FORMAT, SPAWNER_USE_TAG, spawnerUses, MAX_SPAWNER_USES), String.format(LORE_FORMAT, END_FRAME_USE_TAG, endFrameUses, MAX_END_FRAME_USES)));
