package me.esshd.hcf.eventgame.eotw;
...
import me.esshd.hcf.listener.BorderListener;
...
public class EotwHandler {
    ...
    private static final long EOTW_CAPPABLE_WAIT_MILLIS = TimeUnit.MINUTES.toMillis(5L);
