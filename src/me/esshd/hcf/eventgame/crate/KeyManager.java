...
import me.esshd.hcf.eventgame.crate.types.ConquestKey;
import me.esshd.hcf.eventgame.crate.types.KeanuKey;
import me.esshd.hcf.eventgame.crate.types.KothKey;
import me.esshd.hcf.eventgame.crate.types.TropicalKey;
...
public class KeyManager {
    ...
    private final ConquestKey eventKey;

    private final Table<UUID, String, Integer> depositedCrateMap = HashBasedTable.create();
    private final Set<Key> keys;
    private final Config config;
    private final KeanuKey paraKey;
    private final KothKey kothKey;
    private final TropicalKey winterKey;
    public KeyManager(HCF plugin) {
        this.config = new Config(plugin, "key-data");
        this.keys = Sets.newHashSet(new Key[] {  this.paraKey = new KeanuKey(), this.kothKey = new KothKey(), this.eventKey = new ConquestKey(),  this.winterKey = new TropicalKey() });
    ...
    /**
     * Gets the set of {@link Key}s held by this manager.
     *
    ...
    public KeanuKey getParaKey() {
        return this.paraKey;
    }
    public TropicalKey getWinterKey() {
        return this.winterKey;
    }

    public KothKey getKothKey() {
        return kothKey;
    }
