...
public class CaptureZone implements ConfigurationSerializable {
     ...
     *
     * @param name
     *            the name to construct with
     * @param cuboid
     *            the {@link Cuboid} to construct with
     * @param defaultCaptureMillis
     *            the default milliseconds to capture
     */
     ...
     *
     * @param millis
     *            the remaining time in milliseconds until captured
     */
