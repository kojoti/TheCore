...
public interface FactionManager {
    ...
    /**
     * Gets a {@link Faction} which owns a {@link Claim} at specific co-ordinates.
     *
    ...
    /**
     * Gets a {@link PlayerFaction} containing a member who has a {@link UUID} String equal to the given search string.
     *
    ...
    /**
     * Gets a {@link Faction} with a given name or containing a {@link FactionMember} with the given name.
     *
    ...
    /**
     * Saves a {@link Faction} to this manager by a given {@link CommandSender}.
     *
    ...
    /**
     * Removes a {@link Faction} from this manager by a given {@link CommandSender}.
     *
