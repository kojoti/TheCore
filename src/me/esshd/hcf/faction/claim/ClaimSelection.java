 ...
 * <p>
 * Cannot be a {@link Cuboid} as the implementation doesn't allow null locations.
 * </p>
 */
public class ClaimSelection implements Cloneable {
    ...
    /**
     * Constructs a new {@link ClaimSelection} from a given {@link World} and two {@link Location}s.
     *
    ...
    public boolean equals(Object o) {
        ...
        if (world != null ? !world.equals(that.world) : that.world != null)
            return false;
        if (pos1 != null ? !pos1.equals(that.pos1) : that.pos1 != null)
            return false;
