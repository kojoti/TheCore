...
public class Claim extends NamedCuboid implements Cloneable, ConfigurationSerializable {
    ...
    /**
     * Gets a {@link Subclaim} this {@link Claim} has registered with a specific name.
     *
    ...
    public boolean equals(Object o) {
        ...
        if (loaded != blocks.loaded)
            return false;
        if (subclaims != null ? !subclaims.equals(blocks.subclaims) : blocks.subclaims != null)
            return false;
        if (claimUniqueID != null ? !claimUniqueID.equals(blocks.claimUniqueID) : blocks.claimUniqueID != null)
            return false;
        if (factionUUID != null ? !factionUUID.equals(blocks.factionUUID) : blocks.factionUUID != null)
            return false;
