...
import me.esshd.hcf.faction.event.FactionRenameEvent;
...
public abstract class Faction implements ConfigurationSerializable {
    ...
    /**
     * Gets the display name of this {@link Faction} to a viewing {@link CommandSender}.
     *
    ...
    /**
     * Gets the display name of this {@link Faction} to a viewing {@link Faction}.
     *
    ...
    /**
     * Checks if a deathban will be applied when players are killed in the territory of this {@link Faction}.
     *
    ...
    /**
     * Sets if a deathban will be applied when players are killed in the territory of this {@link Faction}.
     * <p>
     * Setting to true will set the DTR multiplier to 1.0
     * </p>
     *
    ...
    /**
     * Gets the deathban multiplier when players are killed in the territory of this {@link Faction}.
     * <p>
     * To disable deathbans completely, set the multiplier to 0
     * </p>
     *
    ...
    /**
     * Sets the deathban multiplier when players are killed in the territory of this {@link Faction}.
     * <p>
     * To disable deathbans completely, set the multiplier to 0
     * </p>
     *
    ...
    public boolean equals(Object o) {
        ...
        if (creationMillis != faction.creationMillis)
            return false;
        if (lastRenameMillis != faction.lastRenameMillis)
            return false;
        if (Double.compare(faction.dtrLossMultiplier, dtrLossMultiplier) != 0)
            return false;
        if (Double.compare(faction.deathbanMultiplier, deathbanMultiplier) != 0)
            return false;
        if (safezone != faction.safezone)
            return false;
        if (uniqueID != null ? !uniqueID.equals(faction.uniqueID) : faction.uniqueID != null)
            return false;
