...
public class FactionAnnouncementArgument extends CommandArgument {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (playerFaction.getMember(player.getUniqueId()).getRole() == Role.MEMBER) {
            sender.sendMessage(ChatColor.RED + "You must be a officer to edit the faction announcement(s).");
            return true;
        }
        ...
        if (oldAnnouncement == null && newAnnouncement == null) {
            sender.sendMessage(ChatColor.RED + "You currently do not have a faction announcement!");
            return true;
        }
        ...
        playerFaction.broadcast(ChatColor.WHITE + player.getName() + " has updated the factions' announcement from " + ChatColor.YELLOW + (oldAnnouncement != null ? oldAnnouncement : "none")
                + ChatColor.YELLOW + " to " + ChatColor.YELLOW + newAnnouncement + '.');
