 ...
 * <p>
 * When a faction has 0 or below DTR (deaths until raidable), they are considered 'raidable'.
 * </p>
 */
public interface Raidable {
    ...
    /**
     * Gets the remaining time in milliseconds until this can start regenerating DTR again.
     *
    ...
    /**
     * Sets the remaining time in milliseconds until this can start regenerating DTR again.
     *
