...
public class ConfigurationService {
    ...
    public static void init(JavaPlugin plugin) {
        ...
        CHAT_FORMAT = config.getString("chat_format", CHAT_FORMAT);
        ...
        NO_ENCHANTS = config.getBoolean("no_enchants", NO_ENCHANTS);
        ...
        MAXCHUNKSPERCLAIM = config.getInt("max_chunks_per_claim", MAXCHUNKSPERCLAIM);

        AUTHENTICATION_KEY = config.getString("key", AUTHENTICATION_KEY);
        CHAT_FORMAT = config.getString("chat_format", CHAT_FORMAT);
        ...
        SNATCH_ENABLED = config.getBoolean("snatch.enabled", SNATCH_ENABLED);
        SNATCH_REQ_POINTS = config.getInt("snatch.pointsToWin", SNATCH_REQ_POINTS);
        SNATCH_POINTS_PER_SECOND = config.getInt("snatch.pointsPerSecond", SNATCH_POINTS_PER_SECOND);
        SNATCH_KING_NAME = config.getString("snatch.kingName", SNATCH_KING_NAME);

        plugin.getLogger().info("Loaded settings.yml.");
    }

    public static String AUTHENTICATION_KEY = "";
    public static String CHAT_FORMAT = "%prefix%%player%: %message%";
    ...
    public static String DONATE_URL = "store.hqpvp.com";

    public static int SPAWN_BUFFER = 200;
    public static int MAP_NUMBER = 3;
    ...
    public static int MAXCHUNKSPERCLAIM = 16;

    public static boolean NO_ENCHANTS = false;
    ...
    public static long DEFAULT_DEATHBAN_DURATION = TimeUnit.HOURS.toMillis(3L);

    // Faction tag colours.
    public static ChatColor TEAMMATE_COLOUR = ChatColor.GREEN;
    public static ChatColor ALLY_COLOUR = ChatColor.LIGHT_PURPLE;
    public static ChatColor ENEMY_COLOUR = ChatColor.DARK_RED;
    ...
    public static String SCOREBOARD_TITLE = ChatColor.GREEN.toString() + ChatColor.BOLD + "   Tuya " + ChatColor.RED + "[Map " + MAP_NUMBER + "]   ";
    ...
    public static boolean SNATCH_ENABLED = true;
    public static int SNATCH_REQ_POINTS = 500;
    public static int SNATCH_POINTS_PER_SECOND = 5;
    public static String SNATCH_KING_NAME = "&e&lTHE KING";
}
