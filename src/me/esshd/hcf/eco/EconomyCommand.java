...
public class EconomyCommand implements CommandExecutor, TabCompleter {
    ...
    public boolean onCommand(final CommandSender sender, final Command command, final String label, final String[] args) {
        ...
        if (GIVE.contains(args[1].toLowerCase())) {
            ...
            sender.sendMessage(new String[]{ChatColor.GOLD + "Added " + EconomyManager.ECONOMY_SYMBOL + JavaUtils.format((Number) amount) + " to balance of " + target.getName() + '.', ChatColor.GOLD + "Balance of " + target.getName() + " is now " + EconomyManager.ECONOMY_SYMBOL + newBalance + '.'});
            return true;
            ...
            sender.sendMessage(new String[]{ChatColor.GOLD + "Taken " + EconomyManager.ECONOMY_SYMBOL + JavaUtils.format((Number) amount) + " from balance of " + target.getName() + '.', ChatColor.GOLD + "Balance of " + target.getName() + " is now " + EconomyManager.ECONOMY_SYMBOL + newBalance + '.'});
            return true;
        } else {
            ...
            sender.sendMessage(ChatColor.GOLD + "Set balance of " + target.getName() + " to " + EconomyManager.ECONOMY_SYMBOL + JavaUtils.format((Number) newBalance) + '.');
            return true;
        }
    }
